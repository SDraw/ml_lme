...
* `_LeftHandThumbCurl` - float
* `_LeftHandIndexCurl` - float
* `_LeftHandMiddleCurl` - float
* `_LeftHandRingCurl` - float
* `_LeftHandPinkyCurl` - float
...
* `_RightHandThumbCurl` - float
* `_RightHandIndexCurl` - float
* `_RightHandMiddleCurl` - float
* `_RightHandRingCurl` - float
* `_RightHandPinkyCurl` - float
